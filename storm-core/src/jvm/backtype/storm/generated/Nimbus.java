...
public class Nimbus {
  ...
  public interface Iface {
    ...
    public void bounce(String name, BounceOptions options) throws NotAliveException, InvalidTopologyException, AuthorizationException, org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void bounce(String name, BounceOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void bounce(String name, BounceOptions options) throws NotAliveException, InvalidTopologyException, AuthorizationException, org.apache.thrift.TException
    {
      send_bounce(name, options);
      recv_bounce();
    }

    public void send_bounce(String name, BounceOptions options) throws org.apache.thrift.TException
    {
      bounce_args args = new bounce_args();
      args.set_name(name);
      args.set_options(options);
      sendBase("bounce", args);
    }

    public void recv_bounce() throws NotAliveException, InvalidTopologyException, AuthorizationException, org.apache.thrift.TException
    {
      bounce_result result = new bounce_result();
      receiveBase(result, "bounce");
      if (result.e != null) {
        throw result.e;
      }
      if (result.ite != null) {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void bounce(String name, BounceOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      bounce_call method_call = new bounce_call(name, options, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class bounce_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String name;
      private BounceOptions options;
      public bounce_call(String name, BounceOptions options, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.name = name;
        this.options = options;
      }
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("bounce", org.apache.thrift.protocol.TMessageType.CALL, 0));
        bounce_args args = new bounce_args();
        args.set_name(name);
        args.set_options(options);
        args.write(prot);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("bounce", new bounce());
    ...
    public static class bounce<I extends Iface> extends org.apache.thrift.ProcessFunction<I, bounce_args> {
      public bounce() {
        super("bounce");
      }

      public bounce_args getEmptyArgsInstance() {
        return new bounce_args();
      }
      ...
      public bounce_result getResult(I iface, bounce_args args) throws org.apache.thrift.TException {
        bounce_result result = new bounce_result();
        try {
          iface.bounce(args.name, args.options);
        } catch (NotAliveException e) {
          result.e = e;
        } catch (InvalidTopologyException ite) {
          result.ite = ite;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class bounce<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, bounce_args, Void> {
      public bounce() {
        super("bounce");
      }
      ...
      public void start(I iface, bounce_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.bounce(args.name, args.options,resultHandler);
      }
    }
  ...
  public static class bounce_args implements org.apache.thrift.TBase<bounce_args, bounce_args._Fields>, java.io.Serializable, Cloneable, Comparable<bounce_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("bounce_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new bounce_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new bounce_argsTupleSchemeFactory());
    }

    private String name; // required
    private BounceOptions options; // required
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(bounce_args.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public bounce_args(bounce_args other) {
      if (other.is_set_name()) {
        this.name = other.name;
      }
      if (other.is_set_options()) {
        this.options = new BounceOptions(other.options);
      }
    }

    public bounce_args deepCopy() {
      return new bounce_args(this);
    }
    ...
    public BounceOptions get_options() {
      return this.options;
    }

    public void set_options(BounceOptions options) {
      this.options = options;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OPTIONS:
        if (value == null) {
          ...
          set_options((BounceOptions)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof bounce_args)
        return this.equals((bounce_args)that);
      return false;
    }

    public boolean equals(bounce_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(bounce_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("bounce_args(");
      boolean first = true;
    ...
    private static class bounce_argsStandardSchemeFactory implements SchemeFactory {
      public bounce_argsStandardScheme getScheme() {
        return new bounce_argsStandardScheme();
      }
    }

    private static class bounce_argsStandardScheme extends StandardScheme<bounce_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, bounce_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // OPTIONS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.options = new BounceOptions();
                struct.options.read(iprot);
                struct.set_options_isSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, bounce_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class bounce_argsTupleSchemeFactory implements SchemeFactory {
      public bounce_argsTupleScheme getScheme() {
        return new bounce_argsTupleScheme();
      }
    }

    private static class bounce_argsTupleScheme extends TupleScheme<bounce_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, bounce_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.is_set_name()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, bounce_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.name = iprot.readString();
  ...
  public static class bounce_result implements org.apache.thrift.TBase<bounce_result, bounce_result._Fields>, java.io.Serializable, Cloneable, Comparable<bounce_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("bounce_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new bounce_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new bounce_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.AZE, new org.apache.thrift.meta_data.FieldMetaData("aze", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(bounce_result.class, metaDataMap);
    }

    public bounce_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public bounce_result(bounce_result other) {
      if (other.is_set_e()) {
        this.e = new NotAliveException(other.e);
      }
      if (other.is_set_ite()) {
    ...
    public bounce_result deepCopy() {
      return new bounce_result(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof bounce_result)
        return this.equals((bounce_result)that);
      return false;
    }

    public boolean equals(bounce_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(bounce_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("bounce_result(");
      boolean first = true;
    ...
    private static class bounce_resultStandardSchemeFactory implements SchemeFactory {
      public bounce_resultStandardScheme getScheme() {
        return new bounce_resultStandardScheme();
      }
    }

    private static class bounce_resultStandardScheme extends StandardScheme<bounce_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, bounce_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, bounce_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class bounce_resultTupleSchemeFactory implements SchemeFactory {
      public bounce_resultTupleScheme getScheme() {
        return new bounce_resultTupleScheme();
      }
    }

    private static class bounce_resultTupleScheme extends TupleScheme<bounce_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, bounce_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.is_set_e()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, bounce_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(3);
        if (incoming.get(0)) {
          struct.e = new NotAliveException();
